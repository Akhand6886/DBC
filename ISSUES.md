...
| 19 | Table editor row index desync on sort/filter | 🔴 Critical | [`src/components/dbms/TableDataEditor.tsx`](file:///Users/alpha/Desktop/antigavity/DBC/src/components/dbms/TableDataEditor.tsx) | ✅ **FIXED** | Preserved `originalIndex` in `displayRows` mapping so edits/deletions apply to underlying row |
| 20 | Inline query cell edits never persist to database driver | 🔴 Critical | [`src/components/dbms/SqlQueryPanel.tsx`](file:///Users/alpha/Desktop/antigavity/DBC/src/components/dbms/SqlQueryPanel.tsx) | ✅ **FIXED** | Auto-generated and executed parameterized `UPDATE` queries against `realSqlDriver` |
| 21 | Rejecting a diff fails to revert active editor buffer | 🔴 Critical | [`src/app/page.tsx`](file:///Users/alpha/Desktop/antigavity/DBC/src/app/page.tsx) | ✅ **FIXED** | Restored `diffCheck.originalContent` into editor buffer and marked status `REJECTED` |
| 22 | Snapshot rollback overwrites active file instead of target file | 🔴 Critical | [`src/app/page.tsx`](file:///Users/alpha/Desktop/antigavity/DBC/src/app/page.tsx) | ✅ **FIXED** | Target `diffCheck.targetFile` recursively in tree, open tabs, and active tab |
| 23 | Renaming file updates `name` but leaves `path` and tabs stale | 🔴 Critical | [`src/app/page.tsx`](file:///Users/alpha/Desktop/antigavity/DBC/src/app/page.tsx) | ✅ **FIXED** | Recalculate node path, recursively update descendant paths, and sync open tabs and active file |
| 24 | Save SQL script saves to root instead of `queries/` folder | 🔴 Critical | [`src/app/page.tsx`](file:///Users/alpha/Desktop/antigavity/DBC/src/app/page.tsx) | ✅ **FIXED** | Inserts saved script into `queries` folder node children and opens newly saved file in tab |
| 25 | Trailing semicolons and newlines break SQL regex mutation parsers | 🟠 High | [`src/lib/db/sqlDriver.ts`](file:///Users/alpha/Desktop/antigavity/DBC/src/lib/db/sqlDriver.ts) | ✅ **FIXED** | Stripped trailing semicolons and sanitized `whereClause` across `executeQuery` |
| 26 | Schema differ ignores dropped/deleted columns | 🟠 High | [`src/lib/db/schemaDiffer.ts`](file:///Users/alpha/Desktop/antigavity/DBC/src/lib/db/schemaDiffer.ts) & [`src/components/modals/SchemaDiffModal.tsx`](file:///Users/alpha/Desktop/antigavity/DBC/src/components/modals/SchemaDiffModal.tsx) | ✅ **FIXED** | Added bidirectional column comparison, generated `ALTER TABLE DROP`, and emitted data loss warnings |
| 27 | Deleting folder leaves open orphan tabs | 🟠 High | [`src/app/page.tsx`](file:///Users/alpha/Desktop/antigavity/DBC/src/app/page.tsx) | ✅ **FIXED** | Collected all descendant IDs and closed matching open tabs and active tab on folder deletion |
| 28 | AST symbol jump opens file at line 1, ignoring line coordinate | 🟠 High | [`src/components/editor/CodeEditor.tsx`](file:///Users/alpha/Desktop/antigavity/DBC/src/components/editor/CodeEditor.tsx) & [`src/app/page.tsx`](file:///Users/alpha/Desktop/antigavity/DBC/src/app/page.tsx) | ✅ **FIXED** | Passed `targetLine` and revealed/positioned Monaco editor to target line coordinate |
| 29 | Unescaped regex in global "Replace All" crashes search | 🟡 Medium | [`src/app/page.tsx`](file:///Users/alpha/Desktop/antigavity/DBC/src/app/page.tsx) | ✅ **FIXED** | Escaped regex metacharacters in replace-all handler and synchronized open editor tabs |
| 30 | Unbounded `terminalLogs` array causes memory leak | 💡 Low | [`src/app/page.tsx`](file:///Users/alpha/Desktop/antigavity/DBC/src/app/page.tsx) | ✅ **FIXED** | Capped terminal log buffer to last 500 entries |
